...
class RegistrosApoyoScreen extends StatefulWidget {
  const RegistrosApoyoScreen({Key? key}) : super(key: key);

  @override
  State<RegistrosApoyoScreen> createState() => RegistrosApoyoScreenState();
}


class RegistrosApoyoScreenState extends State<RegistrosApoyoScreen> {
  ...
  void elimina(id) async {
    response = await dio.get(
        'https://casadelaculturaoaxaca.com/api/administrativo/eliminarRegistro',
        ...
        children: [
          Column(
              children: [
                Card(  elevation: 1,
                  child: Container(
            color: registros.concluido == 'SI' ? Color.fromARGB(255, 131, 226, 134) : Color.fromARGB(255, 243, 243, 243),
                    child: ListTile(
                      leading: InkWell(
                        onTap: () {
                          setState(() {
...
Future<void> _createPDFMenor(String image, String clave, nombre, paterno,
    materno, curp, taller, pRes, mRes, nomRes,telRes, sangre) async {
  PdfDocument document = PdfDocument();
  final page = document.pages.add();
  ...
  page.graphics.drawString(nomRes + " " + pRes + " " + mRes,
      ...
      PdfStandardFont(PdfFontFamily.helvetica, 7, style: PdfFontStyle.bold),
      bounds: const Rect.fromLTWH(290, 190, 184, 0));

      page.graphics.drawString(sangre,
      PdfStandardFont(PdfFontFamily.helvetica, 7, style: PdfFontStyle.bold),
      bounds: const Rect.fromLTWH(290, 210, 184, 0));
