...
class RegistrosJefeScreen extends StatefulWidget {
  const RegistrosJefeScreen({Key? key}) : super(key: key);

  @override
  State<RegistrosJefeScreen> createState() => RegistrosJefeScreenState();
}

class RegistrosJefeScreenState extends State<RegistrosJefeScreen> {
  ...
  Future generateListRegistros() async {
    response = await dio.get(
        ...
        queryParameters: {
          "tipo": "jefe",
          'jefe': cookie.get('idControl').toString()
        });
