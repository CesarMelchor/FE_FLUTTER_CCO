...
class CuerpoVisita1 extends StatefulWidget {
  const CuerpoVisita1({Key? key}) : super(key: key);

  @override
  State<CuerpoVisita1> createState() => _CuerpoVisita1State();
}

class _CuerpoVisita1State extends State<CuerpoVisita1> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    double _width3 = (size.width - ((size.width / 11) * 2)) / 3.4;
    double _width2 = _width3 * 2;
    return Row(
