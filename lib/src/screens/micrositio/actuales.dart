...
class ActualesScreen extends StatefulWidget {
  const ActualesScreen({Key? key}) : super(key: key);

  @override
  State<ActualesScreen> createState() => _ActualesScreenState();
}

class _ActualesScreenState extends State<ActualesScreen>
          ...
          return snapshot.hasData
              ? ListView(
                  children: [
                    ...
                    ) : Image.network("https://casadelaculturaoaxaca.com/images/exposiciones/exposiciones_na.png",
                                              width: size.width),
                    const CustomFooter()
                  ],
                )
