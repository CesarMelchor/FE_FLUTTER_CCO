...
class CarteleraAnterioresScreen extends StatefulWidget {
  const CarteleraAnterioresScreen({Key? key}) : super(key: key);

  @override
  State<CarteleraAnterioresScreen> createState() => _CarteleraAnterioresScreenState();
}

class _CarteleraAnterioresScreenState extends State<CarteleraAnterioresScreen> {
